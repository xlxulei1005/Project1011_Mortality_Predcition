...
def main(args):
    ...
    if args.time_name!= 'default':
        ...
        config['savepath'] = config['savepath'].replace(config['time_name'], args.time_name)
        config['time_name'] = args.time_name
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default='bigru_max', choices=['cnn_rnn', 'bigru_max']) #
    parser.add_argument("--time_name", type=str, default='default', choices=['15m', '12h','24h','6h']) # 
